  ...
  const play = useCallback(() => {
    ...
    const toastOptions = {
      style: {
        ...
        width: "200px",
        position: "fixed",
        top: "100%", // Adjust this value to move the toast lower
        left: "50%",
    ...
    const id = toast.loading(
      <div>
        <img
          src="https://th.bing.com/th/id/R.0962cb1c421e9ae2d83c65f4fa7c939d?rik=s86NNiy2lwrMaA&pid=ImgRaw"
          alt={`Making a pick - ${betNum === 0 ? "ROCK" : betNum === 1 ? "SCISSORS" : "PAPER"} ...`}
          style={{ width: "100px", height: "100px" }}
        />
        <p style={{ marginTop: "10px" }}>
          Picking  {betNum === 0 ? "ROCK" : betNum === 1 ? "SCISSORS" : "PAPER"} ...
        </p>
      </div>,
      {
        ...toastOptions.style,
