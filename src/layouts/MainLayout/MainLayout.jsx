...
const navItems = [
  {
    icon: "/assets/vectors/sidebar/home.png",
    iconActive: "/assets/vectors/sidebar/home.png",
    label: "HOME",
    to: "/",
  },
  {
  ...
  {
    icon: "/assets/vectors/sidebar/rps.png",
    iconActive: "/assets/vectors/sidebar/rps.png",
    label: "RPS",
    to: "/rock-paper-scissor",
  },
  {
    icon: "/assets/vectors/sidebar/dice.png",
    iconActive: "/assets/vectors/sidebar/dice.png",
    label: "DICE",
    to: "/dice",
  },
  // {
      ...
      >
        ...
        <div className="p-2 bg-dark-400 rounded-[28px] flex flex-col justify-between items-center gap-5">
          ...
          <div className="w-full flex flex-col justify-center items-center ">
            ...
            <a href="https://t.me/PLOTBSC" className="w-12 h-12 flex justify-center items-center">
              <img src="/assets/vectors/sidebar/telegram.svg" alt="telegram" />
            </a>
            <a href="#0" className="w-12 h-12 flex justify-center items-center">
              <img src="/assets/vectors/sidebar/x.png" alt="x" />
            </a>
